...
// C'est lui aussi qui monte le FOND D'AURA, pour la même raison : il est sur toutes les
// pages et ne demande rien à leur contrôleur. Le fond est un FRÈRE du bandeau, pas son
// enfant — `.hud` est collé avec un z-index, donc tout ce qu'on y mettrait passerait par
// dessus le contenu au lieu de passer dessous.
export default function Hud() {
  const page = usePage()
  const { auth, balls = 0, chat_unread: chatUnread = 0, aura, page_aura: pageAura } = page.props
  ...
  return (
    <>
      <AuraBackground aura={pageAura !== undefined ? pageAura : aura} />
