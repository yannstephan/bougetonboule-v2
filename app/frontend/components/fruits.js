...
//   top    — la ligne du crâne : le chapeau s'y pose. C'est le sommet du CORPS, tiges,
//            couronnes et palmes exclues — un chapeau ne se pose pas sur la queue d'une cerise.
//   bottom — la ligne du sol : les chaussures s'y posent, l'écharpe juste au-dessus
//   half   — la demi-largeur À LA LIGNE DES BRAS (y = 58), et NON la largeur maximale.
//            ⚠️ C'est la correction de la v2 de ces boîtes : posées à l'œil, elles donnaient
//            la largeur max, ce qui ne vaut que pour un fruit rond. Mesurées au pixel sur la
//            silhouette rendue, quatre fruits étaient faux de 4 à 13 unités : la banane (30 → 18)
//            et la carambole (31 → 17) portaient leur largeur MAXIMALE alors qu'elles sont
//            étranglées à mi-hauteur — les bras flottaient à 13 unités du corps.
//            ⚠️ On mesure la plus longue plage opaque CONTIGUË, pas l'écart entre les deux
//            pixels extrêmes : une épine détachée du corps (les écailles du fruit du dragon)
//            n'est pas de la largeur, et la compter renvoyait les bras dans le vide.
//            Re-mesurer après toute retouche d'une silhouette.
...
export const FRUITS = {
  ...
  papaye:    { shape: 'pear',      body: '#f0932b', dark: '#e58e26', light: '#ffb84d', stem: '#3aa76d', box: BOX(27, 88, 12) },
  banane:    { shape: 'banana',    body: '#ffd93b', dark: '#e0a80c', tip: '#7a5a12', box: BOX(31, 84, 18, 46) },
  ...
  carambole: { shape: 'star',      body: '#f6c945', dark: '#d9a520', light: '#c8e05a', box: BOX(24, 83, 17) },
  goyave:    { shape: 'round',     body: '#7bc96f', dark: '#57964d', light: '#f39ba8', stem: '#3aa76d', box: BOX(27, 86, 30) },
  durian:    { shape: 'spiky',     body: '#c8b45a', dark: '#9a8636', spikeTone: '#8a7a2e', box: BOX(24, 89, 27) },
  corossol:  { shape: 'spiky',     body: '#8fce6f', dark: '#63a047', spikeTone: '#5a9440', box: BOX(24, 89, 27) },

  // — Fruits rouges —
  fraise:          { shape: 'strawberry', body: '#f0325b', dark: '#c81e45', leaf: '#3aa76d', seed: '#ffe08a', box: BOX(25, 86, 21) },
  ...
  mure:            { shape: 'berry',      body: '#5b2a6b', dark: '#3e1c4a', drupTone: '#7a3f8c', box: BOX(25, 84, 23) },
  ...
  sureau:          { shape: 'berry',      body: '#33224a', dark: '#1e1430', drupTone: '#4a3568', box: BOX(25, 84, 23) },
}
