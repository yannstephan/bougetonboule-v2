...
# Pas d'image_processing : l'app ne stocke aucune pièce jointe (les photos de sortie
# sont des URL Strava), donc ni Active Storage ni ses variantes ne sont utilisées.
