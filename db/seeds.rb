...
Cosmetic.create!([
  ...
  # Gants — un de chaque côté, à la largeur du fruit (le droit en miroir)
  ...
  { name: "Griffes de loup",    slot: "hands", rarity: "epic",     price_diamonds: 550,  source: "shop",  emoji: "🐾" },
  # Chaussures — toutes dessinées, une PAIRE vue de face sous le fruit
  ...
  # Auras — une couronne de 6 petits emojis en fond
